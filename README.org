...
** Some Use Cases
- Rabbitgrowth's [[plover-tapey-tape][https://github.com/rabbitgrowth/plover-tapey-tape]] 
	- Output file (tapey/under{}tape.txt)
	- Alternative to Plover's builtin paper tape
- tckmn's [[plover-clippy][https://github.com/tckmn/plover_clippy]]
...
- I would like to thank:
	- Rabbitgrowth: for telling me about tail -f, without them this plugin would not have been made
	 - Make sure to checkout their plugin ([[plover-tapey-tape][https://github.com/rabbitgrowth/plover-tapey-tape]]) for a good alternative to Plover's builtin paper tape
